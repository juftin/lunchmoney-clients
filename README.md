...
changes are merged into the main branch, new versions of the clients are automatically
...
1.  Add the details of your new client to the [openapitools.json](./openapitools.json)
...
2.  Add a TaskFile in the [tasks](./tasks) directory. TaskFiles must implement the
...
3.  Add your client to the `CLIENTS` variable in the root [Taskfile.yaml](./Taskfile.yaml) file,
    and link to your TaskFile created in step 2 in the `includes` section.
