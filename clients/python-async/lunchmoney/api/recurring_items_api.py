...
class RecurringItemsApi:
    ...
    async def get_all_recurring(
        ...
        end_date: Annotated[Optional[date], Field(description="Denotes the end of the range used to populate the `matching` object in the recurring items. Required if start_date exists. ")] = None,
        ...
        :param end_date: Denotes the end of the range used to populate the `matching` object in the recurring items. Required if start_date exists. 
        :type end_date: date
