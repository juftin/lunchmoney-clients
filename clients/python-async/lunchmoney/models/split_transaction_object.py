...
class SplitTransactionObject(BaseModel):
    ...
    payee: Optional[Annotated[str, Field(min_length=0, strict=True)]] = Field(default=None, description="The payee for the child transaction. Will inherit the original payee from the parent if not defined.")
    ...
    category_id: Optional[StrictInt] = Field(default=None, description="Category ID for the child transaction. The category must already exist for the account. If omitted, the child inherits the parent category. If `null`, the child has no category.")
    ...
    notes: Optional[StrictStr] = Field(default=None, description="Notes for the child transaction. If omitted, the child inherits the parent notes. If `null` or an empty string, the child has no notes.")
