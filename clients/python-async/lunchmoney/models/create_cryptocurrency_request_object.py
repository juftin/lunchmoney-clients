...
class CreateCryptocurrencyRequestObject(BaseModel):
    """
    CreateCryptocurrencyRequestObject
    """ # noqa: E501
    coingecko_url: Annotated[str, Field(min_length=1, strict=True, max_length=200)] = Field(description="CoinGecko coin-page URL in the form `https://www.coingecko.com/{locale}/coins/{id}`")
    __properties: ClassVar[List[str]] = ["coingecko_url"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "coingecko_url": obj.get("coingecko_url")
        })
        return _obj
