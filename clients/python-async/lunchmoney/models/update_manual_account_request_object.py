...
class UpdateManualAccountRequestObject(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="If set, the status of the manual account. If set to `closed`, the the `closed_on_date` date will be set to the current date, unless it is also set.")
