...
class BalanceHistorySourceManual(BaseModel):
    """
    Source information for a manual account balance history entry.
    """ # noqa: E501
    type: StrictStr = Field(description="Identifies this entry as belonging to a manual account.")
    manual_account_id: StrictInt = Field(description="ID of the manual account associated with this entry.")
    __properties: ClassVar[List[str]] = ["type", "manual_account_id"]
