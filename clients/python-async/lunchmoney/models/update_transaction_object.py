...
class UpdateTransactionObject(BaseModel):
    ...
    var_date: Optional[date] = Field(default=None, description="Transaction date in ISO 8601 format", alias="date")
    ...
    payee: Optional[Annotated[str, Field(min_length=0, strict=True)]] = Field(default=None, description="The new payee for the transaction. ")
    original_name: Optional[StrictStr] = Field(default=None, description="Original payee name. Cannot be changed. Ignored if set.")
    ...
    notes: Optional[StrictStr] = Field(default=None, description="New notes for the transaction. Set this to an empty string to clear the existing notes. ")
    ...
    additional_tag_ids: Optional[List[StrictInt]] = Field(default=None, description="A list of tag_ids for the tags associated with this transaction. If set, the tags listed in this property will be added to any existing transaction tags. Use `tag_ids` to overwrite or clear transaction tags. If set, `tag_ids` may not be set.")
    ...
    children: Optional[List[ChildTransactionObject]] = Field(default=None, description="An array of child transactions present when a transaction has been split or when the transaction is a group. Split and grouped transactions may not be modified using this API. Ignored if set.")
