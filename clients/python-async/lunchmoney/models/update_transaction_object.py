...
class UpdateTransactionObject(BaseModel):
    ...
    original_name: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=140)]] = Field(default=None, description="Original payee name. Cannot be changed. Ignored if set.")
