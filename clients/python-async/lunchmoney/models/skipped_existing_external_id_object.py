...
class SkippedExistingExternalIdObject(BaseModel):
    ...
    request_transactions_index: Optional[StrictInt] = Field(default=None, description="The index of the transaction in the request body's transactions array that was skipped.")
