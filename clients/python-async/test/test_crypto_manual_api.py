...
class TestCryptoManualApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_create_crypto_manual(self) -> None:
    ...
    async def test_create_cryptocurrency(self) -> None:
    ...
    async def test_delete_crypto_manual(self) -> None:
    ...
    async def test_get_all_crypto_manual(self) -> None:
    ...
    async def test_get_all_cryptocurrencies(self) -> None:
    ...
    async def test_get_crypto_manual_by_id(self) -> None:
    ...
    async def test_update_crypto_manual(self) -> None:
