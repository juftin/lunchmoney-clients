...
class TestCryptoCurrencyResponseObject(unittest.TestCase):
    """CryptoCurrencyResponseObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CryptoCurrencyResponseObject:
        """Test CryptoCurrencyResponseObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CryptoCurrencyResponseObject`
        """
        model = CryptoCurrencyResponseObject()
        if include_optional:
            return CryptoCurrencyResponseObject(
                cryptocurrencies = [
                    lunchmoney.models.crypto_currency_object.cryptoCurrencyObject(
                        id = 56, 
                        coingecko_id = '0', 
                        symbol = '0', 
                        full_name = '0', )
    ...
    def testCryptoCurrencyResponseObject(self):
        """Test CryptoCurrencyResponseObject"""
