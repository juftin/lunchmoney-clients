...
class TestBudgetInvalidPeriodErrorObject(unittest.TestCase):
    """BudgetInvalidPeriodErrorObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BudgetInvalidPeriodErrorObject:
        """Test BudgetInvalidPeriodErrorObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BudgetInvalidPeriodErrorObject`
        """
        model = BudgetInvalidPeriodErrorObject()
        if include_optional:
            return BudgetInvalidPeriodErrorObject(
                message = '',
                requested_start_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                previous_valid_start_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                next_valid_start_date = datetime.datetime.strptime('1975-12-30', '%Y-%m-%d').date(),
                err_msg = ''
            )
        else:
            return BudgetInvalidPeriodErrorObject(
    ...
    def testBudgetInvalidPeriodErrorObject(self):
        """Test BudgetInvalidPeriodErrorObject"""
