...
class TestSyncedCryptoAccount(unittest.TestCase):
    """SyncedCryptoAccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SyncedCryptoAccount:
        """Test SyncedCryptoAccount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SyncedCryptoAccount`
        """
        model = SyncedCryptoAccount()
        if include_optional:
    ...
    def testSyncedCryptoAccount(self):
        """Test SyncedCryptoAccount"""
