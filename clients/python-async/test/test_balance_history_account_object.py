...
class TestBalanceHistoryAccountObject(unittest.TestCase):
    """BalanceHistoryAccountObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BalanceHistoryAccountObject:
        """Test BalanceHistoryAccountObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BalanceHistoryAccountObject`
        """
        model = BalanceHistoryAccountObject()
        if include_optional:
    ...
    def testBalanceHistoryAccountObject(self):
        """Test BalanceHistoryAccountObject"""
