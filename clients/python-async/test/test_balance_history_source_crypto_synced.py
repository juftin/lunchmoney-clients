...
class TestBalanceHistorySourceCryptoSynced(unittest.TestCase):
    """BalanceHistorySourceCryptoSynced unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BalanceHistorySourceCryptoSynced:
        """Test BalanceHistorySourceCryptoSynced
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BalanceHistorySourceCryptoSynced`
        """
        model = BalanceHistorySourceCryptoSynced()
        if include_optional:
            return BalanceHistorySourceCryptoSynced(
                type = 'crypto_synced',
                crypto_synced_id = 56,
                symbol = '0'
            )
    ...
    def testBalanceHistorySourceCryptoSynced(self):
        """Test BalanceHistorySourceCryptoSynced"""
