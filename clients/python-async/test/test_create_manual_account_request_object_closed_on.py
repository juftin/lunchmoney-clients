...
class TestCreateManualAccountRequestObjectClosedOn(unittest.TestCase):
    """CreateManualAccountRequestObjectClosedOn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateManualAccountRequestObjectClosedOn:
        """Test CreateManualAccountRequestObjectClosedOn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateManualAccountRequestObjectClosedOn`
        """
        model = CreateManualAccountRequestObjectClosedOn()
        if include_optional:
    ...
    def testCreateManualAccountRequestObjectClosedOn(self):
        """Test CreateManualAccountRequestObjectClosedOn"""
