...
class TestCryptoSyncedListResponseObject(unittest.TestCase):
    """CryptoSyncedListResponseObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CryptoSyncedListResponseObject:
        """Test CryptoSyncedListResponseObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CryptoSyncedListResponseObject`
        """
        model = CryptoSyncedListResponseObject()
        if include_optional:
            return CryptoSyncedListResponseObject(
                crypto_synced = [
                    lunchmoney.models.synced_crypto_account.synced crypto account(
                        id = 56, 
                        provider = 'kraken', 
                        status = 'active', 
                        created_by_name = '', 
                        ...
                        display_name = '', 
                        balances = [
                            lunchmoney.models.synced_crypto_balance_object.synced crypto balance object(
                                name = '0', 
                                display_name = '', 
                                balance = '-80728', 
                                symbol = '0', 
    ...
    def testCryptoSyncedListResponseObject(self):
        """Test CryptoSyncedListResponseObject"""
