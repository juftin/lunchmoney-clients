...
class TestCurrentBalanceHistoryEntry(unittest.TestCase):
    """CurrentBalanceHistoryEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CurrentBalanceHistoryEntry:
        """Test CurrentBalanceHistoryEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CurrentBalanceHistoryEntry`
        """
        model = CurrentBalanceHistoryEntry()
        if include_optional:
            return CurrentBalanceHistoryEntry(
                type = 'current',
                month = '2026-07',
                balance = '-80728',
                currency = 'aed',
    ...
    def testCurrentBalanceHistoryEntry(self):
        """Test CurrentBalanceHistoryEntry"""
