...
class TestCryptoManualListResponseObject(unittest.TestCase):
    """CryptoManualListResponseObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CryptoManualListResponseObject:
        """Test CryptoManualListResponseObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CryptoManualListResponseObject`
        """
        model = CryptoManualListResponseObject()
        if include_optional:
            return CryptoManualListResponseObject(
                crypto_manual = [
                    lunchmoney.models.manual_crypto_object.manual crypto object(
                        id = 56, 
                        name = '0', 
                        display_name = '', 
                        institution_name = '0', 
    ...
    def testCryptoManualListResponseObject(self):
        """Test CryptoManualListResponseObject"""
