...
class TestBalanceHistoryListResponseObject(unittest.TestCase):
    """BalanceHistoryListResponseObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BalanceHistoryListResponseObject:
        """Test BalanceHistoryListResponseObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BalanceHistoryListResponseObject`
        """
        model = BalanceHistoryListResponseObject()
        if include_optional:
            return BalanceHistoryListResponseObject(
                balance_history = [
                    lunchmoney.models.balance_history_for_an_account_object.balance history for an account object(
                        source = null, 
                        balances = [
                            null
                            ], )
    ...
    def testBalanceHistoryListResponseObject(self):
        """Test BalanceHistoryListResponseObject"""
