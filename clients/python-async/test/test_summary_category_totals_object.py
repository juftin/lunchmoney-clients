...
class TestSummaryCategoryTotalsObject(unittest.TestCase):
    """SummaryCategoryTotalsObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SummaryCategoryTotalsObject:
        """Test SummaryCategoryTotalsObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SummaryCategoryTotalsObject`
        """
        model = SummaryCategoryTotalsObject()
        if include_optional:
            return SummaryCategoryTotalsObject(
    ...
    def testSummaryCategoryTotalsObject(self):
        """Test SummaryCategoryTotalsObject"""
