...
class TestUpdateBalanceHistoryDetailsResponseObject(unittest.TestCase):
    """UpdateBalanceHistoryDetailsResponseObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateBalanceHistoryDetailsResponseObject:
        """Test UpdateBalanceHistoryDetailsResponseObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateBalanceHistoryDetailsResponseObject`
        """
        model = UpdateBalanceHistoryDetailsResponseObject()
        if include_optional:
    ...
    def testUpdateBalanceHistoryDetailsResponseObject(self):
        """Test UpdateBalanceHistoryDetailsResponseObject"""
