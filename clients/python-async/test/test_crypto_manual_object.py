...
class TestCryptoManualObject(unittest.TestCase):
    """CryptoManualObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CryptoManualObject:
        """Test CryptoManualObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CryptoManualObject`
        """
        model = CryptoManualObject()
        if include_optional:
    ...
    def testCryptoManualObject(self):
        """Test CryptoManualObject"""
