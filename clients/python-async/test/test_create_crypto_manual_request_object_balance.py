...
class TestCreateCryptoManualRequestObjectBalance(unittest.TestCase):
    """CreateCryptoManualRequestObjectBalance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCryptoManualRequestObjectBalance:
        """Test CreateCryptoManualRequestObjectBalance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCryptoManualRequestObjectBalance`
        """
        model = CreateCryptoManualRequestObjectBalance()
        if include_optional:
    ...
    def testCreateCryptoManualRequestObjectBalance(self):
        """Test CreateCryptoManualRequestObjectBalance"""
