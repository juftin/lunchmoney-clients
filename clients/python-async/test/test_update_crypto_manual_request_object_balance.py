...
class TestUpdateCryptoManualRequestObjectBalance(unittest.TestCase):
    """UpdateCryptoManualRequestObjectBalance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateCryptoManualRequestObjectBalance:
        """Test UpdateCryptoManualRequestObjectBalance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateCryptoManualRequestObjectBalance`
        """
        model = UpdateCryptoManualRequestObjectBalance()
        if include_optional:
    ...
    def testUpdateCryptoManualRequestObjectBalance(self):
        """Test UpdateCryptoManualRequestObjectBalance"""
