...
class TestBalanceHistoryUpdateItemObjectBalance(unittest.TestCase):
    """BalanceHistoryUpdateItemObjectBalance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BalanceHistoryUpdateItemObjectBalance:
        """Test BalanceHistoryUpdateItemObjectBalance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BalanceHistoryUpdateItemObjectBalance`
        """
        model = BalanceHistoryUpdateItemObjectBalance()
        if include_optional:
    ...
    def testBalanceHistoryUpdateItemObjectBalance(self):
        """Test BalanceHistoryUpdateItemObjectBalance"""
