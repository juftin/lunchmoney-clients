...
class TestSummaryResponseObject(unittest.TestCase):
    """SummaryResponseObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SummaryResponseObject:
        """Test SummaryResponseObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SummaryResponseObject`
        """
        model = SummaryResponseObject()
        if include_optional:
            return SummaryResponseObject(
                aligned = True,
                categories = [
                    lunchmoney.models.summary_category_object.summaryCategoryObject(
                        category_id = 56, 
    ...
    def testSummaryResponseObject(self):
        """Test SummaryResponseObject"""
