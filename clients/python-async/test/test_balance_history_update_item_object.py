...
class TestBalanceHistoryUpdateItemObject(unittest.TestCase):
    """BalanceHistoryUpdateItemObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BalanceHistoryUpdateItemObject:
        """Test BalanceHistoryUpdateItemObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BalanceHistoryUpdateItemObject`
        """
        model = BalanceHistoryUpdateItemObject()
        if include_optional:
            return BalanceHistoryUpdateItemObject(
                id = 56,
                month = '2026-06',
                balance = None,
                symbol = '0',
    ...
    def testBalanceHistoryUpdateItemObject(self):
        """Test BalanceHistoryUpdateItemObject"""
