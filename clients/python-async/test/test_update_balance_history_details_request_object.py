...
class TestUpdateBalanceHistoryDetailsRequestObject(unittest.TestCase):
    """UpdateBalanceHistoryDetailsRequestObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateBalanceHistoryDetailsRequestObject:
        """Test UpdateBalanceHistoryDetailsRequestObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateBalanceHistoryDetailsRequestObject`
        """
        model = UpdateBalanceHistoryDetailsRequestObject()
        if include_optional:
            return UpdateBalanceHistoryDetailsRequestObject(
                name = '',
                institution_name = '',
                display_name = '',
                account_type = '',
    ...
    def testUpdateBalanceHistoryDetailsRequestObject(self):
        """Test UpdateBalanceHistoryDetailsRequestObject"""
