...
class TestBalanceHistoryAccountObjectSource(unittest.TestCase):
    """BalanceHistoryAccountObjectSource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BalanceHistoryAccountObjectSource:
        """Test BalanceHistoryAccountObjectSource
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BalanceHistoryAccountObjectSource`
        """
        model = BalanceHistoryAccountObjectSource()
        if include_optional:
    ...
    def testBalanceHistoryAccountObjectSource(self):
        """Test BalanceHistoryAccountObjectSource"""
