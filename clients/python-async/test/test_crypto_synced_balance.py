...
class TestCryptoSyncedBalance(unittest.TestCase):
    """CryptoSyncedBalance unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CryptoSyncedBalance:
        """Test CryptoSyncedBalance
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CryptoSyncedBalance`
        """
        model = CryptoSyncedBalance()
        if include_optional:
    ...
    def testCryptoSyncedBalance(self):
        """Test CryptoSyncedBalance"""
