...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a manual account
        api_response = await api_instance.create_manual_account(create_manual_account_request_object)
...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a manual account
        await api_instance.delete_manual_account(id, delete_items=delete_items, delete_balance_history=delete_balance_history)
    except Exception as e:
...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Get all manual accounts
        api_response = await api_instance.get_all_manual_accounts()
...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a single manual account
        api_response = await api_instance.get_manual_account_by_id(id)
...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Update an existing manual account
        api_response = await api_instance.update_manual_account(id, update_manual_account_request_object)
