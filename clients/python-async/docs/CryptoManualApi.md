...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Create a manual crypto balance
        api_response = await api_instance.create_crypto_manual(create_crypto_manual_request_object)
...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Add a new supported cryptocurrency
        api_response = await api_instance.create_cryptocurrency(create_cryptocurrency_request_object)
...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a manual crypto balance
        await api_instance.delete_crypto_manual(id, keep_history=keep_history)
    except Exception as e:
...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Get all manual crypto balances
        api_response = await api_instance.get_all_crypto_manual()
...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Get all supported cryptocurrencies
        api_response = await api_instance.get_all_cryptocurrencies()
...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a single manual crypto balance
        api_response = await api_instance.get_crypto_manual_by_id(id)
...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a manual crypto balance
        api_response = await api_instance.update_crypto_manual(id, update_crypto_manual_request_object)
