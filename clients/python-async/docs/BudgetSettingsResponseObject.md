...
**budget_hide_no_activity** | **bool** | The display preference for hiding categories in budget view that have no activity and no budgeted value | [default to False]
**budget_use_last_day_of_month** | **bool** | The display preference for using the last day of the month as the period end for monthly periods | [default to False]
