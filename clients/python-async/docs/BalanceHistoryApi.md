...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete all balance history for an account
        await api_instance.delete_balance_history_for_account(account_type, account_id)
    except Exception as e:
...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete all balance history for a synced crypto symbol
        await api_instance.delete_balance_history_for_crypto_synced(account_id, symbol)
    except Exception as e:
...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Get balance history
        api_response = await api_instance.get_balance_history(start_month=start_month, end_month=end_month)
...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Get balance history for an account
        api_response = await api_instance.get_balance_history_for_account(account_type, account_id, start_month=start_month, end_month=end_month)
...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Get balance history for a synced crypto symbol
        api_response = await api_instance.get_balance_history_for_crypto_synced(account_id, symbol, start_month=start_month, end_month=end_month)
...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Update details for a deleted account
        api_response = await api_instance.update_balance_history_details(account_id, update_balance_history_details_request_object)
...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Upsert balance history for an account
        api_response = await api_instance.upsert_balance_history_for_account(account_type, account_id, upsert_balance_history_request_object)
...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Upsert balance history for a synced crypto symbol
        api_response = await api_instance.upsert_balance_history_for_crypto_synced(account_id, symbol, upsert_balance_history_request_object)
