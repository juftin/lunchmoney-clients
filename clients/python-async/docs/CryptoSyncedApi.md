...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Get all synced crypto accounts
        api_response = await api_instance.get_all_crypto_synced()
...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a synced crypto balance by symbol
        api_response = await api_instance.get_crypto_synced_balance_by_symbol(id, symbol)
...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a single synced crypto account
        api_response = await api_instance.get_crypto_synced_by_id(id)
...
async with lunchmoney.ApiClient(configuration) as api_client:
    ...
    try:
        # Refresh balances for a synced crypto account
        api_response = await api_instance.refresh_crypto_synced(id)
