...
class TestUpdateManualAccountRequestObjectClosedOn(unittest.TestCase):
    """UpdateManualAccountRequestObjectClosedOn unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateManualAccountRequestObjectClosedOn:
        """Test UpdateManualAccountRequestObjectClosedOn
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateManualAccountRequestObjectClosedOn`
        """
        model = UpdateManualAccountRequestObjectClosedOn()
        if include_optional:
    ...
    def testUpdateManualAccountRequestObjectClosedOn(self):
        """Test UpdateManualAccountRequestObjectClosedOn"""
