...
class TestBudgetUpsertResponseObject(unittest.TestCase):
    """BudgetUpsertResponseObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BudgetUpsertResponseObject:
        """Test BudgetUpsertResponseObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BudgetUpsertResponseObject`
        """
        model = BudgetUpsertResponseObject()
        if include_optional:
    ...
    def testBudgetUpsertResponseObject(self):
        """Test BudgetUpsertResponseObject"""
