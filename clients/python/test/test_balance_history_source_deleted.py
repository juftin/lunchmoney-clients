...
class TestBalanceHistorySourceDeleted(unittest.TestCase):
    """BalanceHistorySourceDeleted unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BalanceHistorySourceDeleted:
        """Test BalanceHistorySourceDeleted
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BalanceHistorySourceDeleted`
        """
        model = BalanceHistorySourceDeleted()
        if include_optional:
            return BalanceHistorySourceDeleted(
                type = 'deleted',
    ...
    def testBalanceHistorySourceDeleted(self):
        """Test BalanceHistorySourceDeleted"""
