...
class TestUpsertBudgetRequestObject(unittest.TestCase):
    """UpsertBudgetRequestObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertBudgetRequestObject:
        """Test UpsertBudgetRequestObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertBudgetRequestObject`
        """
        model = UpsertBudgetRequestObject()
        if include_optional:
    ...
    def testUpsertBudgetRequestObject(self):
        """Test UpsertBudgetRequestObject"""
