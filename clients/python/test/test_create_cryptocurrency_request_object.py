...
class TestCreateCryptocurrencyRequestObject(unittest.TestCase):
    """CreateCryptocurrencyRequestObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCryptocurrencyRequestObject:
        """Test CreateCryptocurrencyRequestObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCryptocurrencyRequestObject`
        """
        model = CreateCryptocurrencyRequestObject()
        if include_optional:
            return CreateCryptocurrencyRequestObject(
    ...
    def testCreateCryptocurrencyRequestObject(self):
        """Test CreateCryptocurrencyRequestObject"""
