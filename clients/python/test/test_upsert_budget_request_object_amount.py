...
class TestUpsertBudgetRequestObjectAmount(unittest.TestCase):
    """UpsertBudgetRequestObjectAmount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertBudgetRequestObjectAmount:
        """Test UpsertBudgetRequestObjectAmount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertBudgetRequestObjectAmount`
        """
        model = UpsertBudgetRequestObjectAmount()
        if include_optional:
    ...
    def testUpsertBudgetRequestObjectAmount(self):
        """Test UpsertBudgetRequestObjectAmount"""
