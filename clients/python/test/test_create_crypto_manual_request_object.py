...
class TestCreateCryptoManualRequestObject(unittest.TestCase):
    """CreateCryptoManualRequestObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCryptoManualRequestObject:
        """Test CreateCryptoManualRequestObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCryptoManualRequestObject`
        """
        model = CreateCryptoManualRequestObject()
        if include_optional:
            return CreateCryptoManualRequestObject(
                name = 'Cold Wallet BTC',
                display_name = 'Cold Storage',
                institution_name = 'Ledger',
                balance = 0.523400000000000000,
                symbol = 'btc'
            )
        else:
            return CreateCryptoManualRequestObject(
    ...
    def testCreateCryptoManualRequestObject(self):
        """Test CreateCryptoManualRequestObject"""
