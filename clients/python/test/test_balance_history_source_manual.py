...
class TestBalanceHistorySourceManual(unittest.TestCase):
    """BalanceHistorySourceManual unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BalanceHistorySourceManual:
        """Test BalanceHistorySourceManual
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BalanceHistorySourceManual`
        """
        model = BalanceHistorySourceManual()
        if include_optional:
            return BalanceHistorySourceManual(
                type = 'manual',
    ...
    def testBalanceHistorySourceManual(self):
        """Test BalanceHistorySourceManual"""
