...
class TestCryptoSyncedApi(unittest.TestCase):
    ...
    def test_get_all_crypto_synced(self) -> None:
    ...
    def test_get_crypto_synced_balance_by_symbol(self) -> None:
    ...
    def test_get_crypto_synced_by_id(self) -> None:
    ...
    def test_refresh_crypto_synced(self) -> None:
