    ...
    def make_instance(self, include_optional) -> InsertTransactionsResponseObject:
        ...
        if include_optional:
            return InsertTransactionsResponseObject(
                ...
                skipped_duplicates = [
                    lunchmoney-python.models.skipped_existing_external_id_object.skippedExistingExternalIdObject(
                        reason = 'duplicate_external_id', 
                        request_transactions_index = 56, 
                        existing_transaction_id = 56, 
                        request_transaction = lunchmoney-python.models.request_transaction.request_transaction(), )
                    ]
            )
        else:
            return InsertTransactionsResponseObject(
