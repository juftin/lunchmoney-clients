...
class TestBalanceHistoryApi(unittest.TestCase):
    ...
    def test_delete_balance_history_entry(self) -> None:
    ...
    def test_delete_balance_history_for_account(self) -> None:
    ...
    def test_delete_balance_history_for_crypto_synced(self) -> None:
    ...
    def test_get_balance_history_for_account(self) -> None:
    ...
    def test_get_balance_history_for_crypto_synced(self) -> None:
    ...
    def test_update_balance_history_details(self) -> None:
    ...
    def test_upsert_balance_history_for_account(self) -> None:
    ...
    def test_upsert_balance_history_for_crypto_synced(self) -> None:
