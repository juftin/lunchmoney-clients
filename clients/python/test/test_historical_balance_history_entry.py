...
class TestHistoricalBalanceHistoryEntry(unittest.TestCase):
    """HistoricalBalanceHistoryEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HistoricalBalanceHistoryEntry:
        """Test HistoricalBalanceHistoryEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HistoricalBalanceHistoryEntry`
        """
        model = HistoricalBalanceHistoryEntry()
        if include_optional:
            return HistoricalBalanceHistoryEntry(
                type = 'historical',
                id = 56,
                month = '2026-06',
                balance = '-80728',
    ...
    def testHistoricalBalanceHistoryEntry(self):
        """Test HistoricalBalanceHistoryEntry"""
