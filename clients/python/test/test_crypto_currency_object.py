...
class TestCryptoCurrencyObject(unittest.TestCase):
    """CryptoCurrencyObject unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CryptoCurrencyObject:
        """Test CryptoCurrencyObject
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CryptoCurrencyObject`
        """
        model = CryptoCurrencyObject()
        if include_optional:
    ...
    def testCryptoCurrencyObject(self):
        """Test CryptoCurrencyObject"""
