...
class TestBalanceHistorySourcePlaid(unittest.TestCase):
    """BalanceHistorySourcePlaid unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BalanceHistorySourcePlaid:
        """Test BalanceHistorySourcePlaid
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BalanceHistorySourcePlaid`
        """
        model = BalanceHistorySourcePlaid()
        if include_optional:
            return BalanceHistorySourcePlaid(
                type = 'plaid',
                plaid_account_id = 56
            )
        else:
    ...
    def testBalanceHistorySourcePlaid(self):
        """Test BalanceHistorySourcePlaid"""
