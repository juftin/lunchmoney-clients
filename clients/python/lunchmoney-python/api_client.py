...
from lunchmoney-python.configuration import Configuration
from lunchmoney-python.api_response import ApiResponse, T as ApiResponseT
import lunchmoney-python.models
from lunchmoney-python import rest
from lunchmoney-python.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(lunchmoney-python.models, klass)
