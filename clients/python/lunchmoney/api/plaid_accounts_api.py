...
class PlaidAccountsApi:
    ...
    def trigger_plaid_account_fetch(
        self,
        start_date: Annotated[Optional[date], Field(description="Indicates the beginning of the time period to fetch transactions for. If omitted, the most recent transactions will be returned. <br> Required if end_date exists. <br>")] = None,
        ...
        :param start_date: Indicates the beginning of the time period to fetch transactions for. If omitted, the most recent transactions will be returned. <br> Required if end_date exists. <br>
