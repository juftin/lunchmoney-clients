...
class CryptoSyncedApi:
    ...
    @validate_call
    def get_all_crypto_synced_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_all_crypto_synced_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_crypto_synced_balance_by_symbol(
        self,
    ...
    @validate_call
    def get_crypto_synced_balance_by_symbol_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Synced crypto account ID")],
        symbol: Annotated[str, Field(min_length=1, strict=True, max_length=25, description="Crypto symbol within the synced account")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_crypto_synced_balance_by_symbol_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Synced crypto account ID")],
        symbol: Annotated[str, Field(min_length=1, strict=True, max_length=25, description="Crypto symbol within the synced account")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_crypto_synced_by_id_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Synced crypto account ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_crypto_synced_by_id_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Synced crypto account ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def refresh_crypto_synced_with_http_info(
        self,
        id: Annotated[StrictInt, Field(description="Synced crypto account ID")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def refresh_crypto_synced_without_preload_content(
        self,
        id: Annotated[StrictInt, Field(description="Synced crypto account ID")],
        _request_timeout: Union[
            None,
