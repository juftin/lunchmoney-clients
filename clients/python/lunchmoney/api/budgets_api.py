...
class BudgetsApi:
    ...
    def get_budget_settings(
        ...
        Returns budget period and display settings for the budget associated with this API token.<p> These control how budget **periods** are calculated (granularity, anchor date, rollover, and related options).
