...
class TransactionsBulkApi:
    ...
    def get_all_transactions(
        self,
        start_date: Annotated[Optional[date], Field(description="Indicates the beginning of the time period to fetch transactions for. If omitted, the most recent transactions will be returned. See `limit`. Required if end_date exists. <br>")] = None,
        end_date: Annotated[Optional[date], Field(description="Indicates the end of the time period to fetch transactions for. Required if start_date exists. ")] = None,
        ...
        manual_account_id: Annotated[Optional[StrictInt], Field(description="Filter transactions to those associated with specified manual account ID or set this to 0 to omit any transactions from manual accounts. Setting both this and `plaid_account_id` to 0 will return transactions with no account. These are listed as \"Cash Transactions\" in the Lunch Money app.<br> Note that transaction groups are not associated with any account. If you want the response to include transactions from transaction groups, set the `include_group_children` query parameter to `true` when filtering by manual accounts.")] = None,
        plaid_account_id: Annotated[Optional[StrictInt], Field(description="Filter transactions to those associated with specified plaid account ID or set this to 0 to omit any transactions from plaid accounts. Setting both this and `manual_account_id` to 0 will return transactions with no account. These are listed as \"Cash Transactions\" in the Lunch Money app.<br> Note that transaction groups are not associated with any account. If you want the response to include transactions from transaction groups, set the `include_group_children` query parameter to `true` when filtering by plaid accounts.")] = None,
        recurring_id: Annotated[Optional[StrictInt], Field(description="Filter transactions to those associated with the specified recurring item ID. ")] = None,
        category_id: Annotated[Optional[StrictInt], Field(description="Filter transactions to those associated with the specified category ID. Will also match category groups. Set this to 0 to return only uncategorized transactions.")] = None,
        tag_id: Annotated[Optional[StrictInt], Field(description="Filter transactions to those that have the specified tag ID")] = None,
        ...
        include_metadata: Annotated[Optional[StrictBool], Field(description="By default, custom and plaid metadata are not included in the response. Set to true if you'd like the returned transaction objects to include any metadata associated with the transactions.")] = None,
        ...
        include_files: Annotated[Optional[StrictBool], Field(description="By default, the `files` property is not included in the response. Set to true if you'd like the responses to include a list of objects that describe any files attached to the transactions.")] = None,
        limit: Annotated[Optional[Annotated[int, Field(le=2000, strict=True, ge=1)]], Field(description="Sets the maximum number of transactions to return. If more match the filter criteria, the response will include a `has_more` attribute set to `true`. See [Pagination](https://lunchmoney.dev/v2/pagination)")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="Sets the offset for the records returned. This is typically set automatically in the header. See [Pagination](https://lunchmoney.dev/v2/pagination)")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param start_date: Indicates the beginning of the time period to fetch transactions for. If omitted, the most recent transactions will be returned. See `limit`. Required if end_date exists. <br>
        :type start_date: date
        :param end_date: Indicates the end of the time period to fetch transactions for. Required if start_date exists. 
        :type end_date: date
        ...
        :param recurring_id: Filter transactions to those associated with the specified recurring item ID. 
        :type recurring_id: int
        :param category_id: Filter transactions to those associated with the specified category ID. Will also match category groups. Set this to 0 to return only uncategorized transactions.
        :type category_id: int
        :param tag_id: Filter transactions to those that have the specified tag ID
        :type tag_id: int
        ...
        :param include_metadata: By default, custom and plaid metadata are not included in the response. Set to true if you'd like the returned transaction objects to include any metadata associated with the transactions.
        ...
        :param include_files: By default, the `files` property is not included in the response. Set to true if you'd like the responses to include a list of objects that describe any files attached to the transactions.
        :type include_files: bool
        :param limit: Sets the maximum number of transactions to return. If more match the filter criteria, the response will include a `has_more` attribute set to `true`. See [Pagination](https://lunchmoney.dev/v2/pagination)
        :type limit: int
        :param offset: Sets the offset for the records returned. This is typically set automatically in the header. See [Pagination](https://lunchmoney.dev/v2/pagination)
        :type offset: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
