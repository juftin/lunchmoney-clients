...
class RecurringItemsApi:
    ...
    def get_all_recurring(
        self,
        start_date: Annotated[Optional[date], Field(description="Indicates the beginning of the range used to populate the `matching` object in the recurring items. If omitted, the current month will be used as the range.<br> Required if end_date exists.")] = None,
        end_date: Annotated[Optional[date], Field(description="Indicates the end of the range used to populate the `matching` object in the recurring items. Required if start_date exists. ")] = None,
        ...
        :param start_date: Indicates the beginning of the range used to populate the `matching` object in the recurring items. If omitted, the current month will be used as the range.<br> Required if end_date exists.
        :type start_date: date
        :param end_date: Indicates the end of the range used to populate the `matching` object in the recurring items. Required if start_date exists. 
        :type end_date: date
