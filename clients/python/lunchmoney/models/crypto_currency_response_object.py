...
class CryptoCurrencyResponseObject(BaseModel):
    """
    CryptoCurrencyResponseObject
    """ # noqa: E501
    cryptocurrencies: List[CryptoCurrencyObject] = Field(description="List of cryptocurrencies currently supported for manual tracking.")
    __properties: ClassVar[List[str]] = ["cryptocurrencies"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cryptocurrencies": [CryptoCurrencyObject.from_dict(_item) for _item in obj["cryptocurrencies"]] if obj.get("cryptocurrencies") is not None else None
        })
        return _obj
