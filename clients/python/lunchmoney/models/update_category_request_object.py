...
class UpdateCategoryRequestObject(BaseModel):
    ...
    order: Optional[StrictInt] = Field(default=None, description="System or GUI set  specifying the position in which the category is displayed on the categories page in the Lunch Money GUI. Ignored if set.")
    __properties: ClassVar[List[str]] = ["name", "description", "is_income", "exclude_from_budget", "exclude_from_totals", "archived", "group_id", "is_group", "children", "id", "archived_at", "updated_at", "created_at", "order"]
