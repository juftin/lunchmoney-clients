...
class UpdateCategoryRequestObject(BaseModel):
    ...
    archived_at: Optional[datetime] = Field(default=None, description="If set, updates the archived timestamp for the category. Provide an ISO 8601 extended datetime or `null` to clear it.")
