...
class RecurringObjectTransactionCriteria(BaseModel):
    ...
    """ # noqa: E501
    start_date: Optional[date] = Field(default=None, description="The beginning of the date range for matching transactions. If `null`, any transactions before end_date may be considered.")
    end_date: Optional[date] = Field(default=None, description="The end of the date range for matching transactions. If `null`, any transactions after start_date may be considered.")
    granularity: Optional[StrictStr] = Field(default=None, description="The unit of time used to define the cadence of the recurring item.")
    quantity: Optional[StrictInt] = Field(default=None, description="The number of granularity units between each recurrence.")
    anchor_date: Optional[date] = Field(default=None, description="The date used in conjunction with the `quantity` and `granularity` properties to calculate expected occurrences of recurring transactions.")
    payee: Optional[StrictStr] = Field(default=None, description="If set, represents the original transaction payee name that triggered this recurring item's creation.")
    amount: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="The expected amount for a transaction that will match this recurring item. For recurring items that have a flexible amount this is the average of the specified min and max amounts.")
    currency: Optional[StrictStr] = Field(default=None, description="Three-letter lowercase currency code of the recurring item.")
    plaid_account_id: Optional[StrictInt] = Field(default=None, description="The Plaid account ID associated with the recurring item, if any.")
    manual_account_id: Optional[StrictInt] = Field(default=None, description="The manual account ID associated with the recurring item, if any.")
    __properties: ClassVar[List[str]] = ["start_date", "end_date", "granularity", "quantity", "anchor_date", "payee", "amount", "currency", "plaid_account_id", "manual_account_id"]
