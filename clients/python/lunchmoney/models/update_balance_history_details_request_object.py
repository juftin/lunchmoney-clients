...
class UpdateBalanceHistoryDetailsRequestObject(BaseModel):
    """
    UpdateBalanceHistoryDetailsRequestObject
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="New archived account name for the deleted account source")
    institution_name: Optional[StrictStr] = Field(default=None, description="New archived institution name for the deleted account source")
    display_name: Optional[StrictStr] = Field(default=None, description="New display name for the deleted account source")
    account_type: Optional[StrictStr] = Field(default=None, description="New archived account type for the deleted account source")
    subtype: Optional[StrictStr] = Field(default=None, description="New archived subtype for the deleted account source")
    mask: Optional[StrictStr] = Field(default=None, description="New archived account mask for the deleted account source")
