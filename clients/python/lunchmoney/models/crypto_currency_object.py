...
class CryptoCurrencyObject(BaseModel):
    """
    CryptoCurrencyObject
    """ # noqa: E501
    id: StrictInt = Field(description="System-defined unique identifier for this cryptocurrency in Lunch Money.")
    coingecko_id: Annotated[str, Field(min_length=1, strict=True, max_length=100)] = Field(description="System-defined CoinGecko identifier used to fetch the USD-based prices for this cryptocurrency.")
    symbol: Annotated[str, Field(min_length=1, strict=True, max_length=25)] = Field(description="Lowercase currency symbol that must be used as `symbol` when creating a manual crypto balance.")
    full_name: Annotated[str, Field(min_length=1, strict=True, max_length=200)] = Field(description="Human-readable name of the cryptocurrency.")
    __properties: ClassVar[List[str]] = ["id", "coingecko_id", "symbol", "full_name"]
