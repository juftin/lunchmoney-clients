...
class CategoryObject(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "description", "is_income", "exclude_from_budget", "exclude_from_totals", "updated_at", "created_at", "group_id", "is_group", "children", "archived", "archived_at", "order"]
