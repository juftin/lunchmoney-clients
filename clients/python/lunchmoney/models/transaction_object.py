...
class TransactionObject(BaseModel):
    ...
    original_name: Optional[Annotated[str, Field(min_length=0, strict=True, max_length=140)]] = Field(default=None, description="Original payee name from the source (financial institution, CSV, etc.). For Plaid transactions, this is the raw name before normalization. For manual/API transactions, this typically matches `payee`. May be null for older transactions.")
