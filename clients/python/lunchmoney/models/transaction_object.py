...
class TransactionObject(BaseModel):
    ...
    parent_id: Optional[StrictInt] = Field(description="A transaction ID if this is a split transaction. Denotes the transaction ID of the original, or parent, transaction. Is null if this is not a split transaction")
    ...
    __properties: ClassVar[List[str]] = ["id", "date", "amount", "currency", "to_base", "recurring_id", "payee", "category_id", "plaid_account_id", "manual_account_id", "external_id", "tag_ids", "notes", "status", "is_pending", "created_at", "updated_at", "is_parent", "parent_id", "is_group", "group_id", "children", "plaid_metadata", "custom_metadata", "files", "source"]
