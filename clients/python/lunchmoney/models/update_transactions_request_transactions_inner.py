...
class UpdateTransactionsRequestTransactionsInner(BaseModel):
    ...
    category_id: Optional[StrictInt] = Field(default=None, description="Unique identifier of the category for this transaction. Set this to 0 to clear the transaction's category.")
    ...
    manual_account_id: Optional[StrictInt] = Field(default=None, description="The unique identifier of the manual account associated with this transaction. Set this to zero to disassociate the transaction with an account. If set `plaid_account_id` may not also be set to a non zero value. Moving an existing transaction to to another account will not work if the transaction belongs to a synced account who's \"Allow Modifications to Transactions\" property is not set.")
    plaid_account_id: Optional[StrictInt] = Field(default=None, description="The unique identifier of the plaid account associated with this transaction. If set `manual_account_id` may not also be set to a non zero value. Moving an existing transaction to to an existing Plaid account will not work if the account's \"Allow Modifications to Transactions\" property is not set.")
    ...
    to_base: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="System defined amount of this transaction in the user's primary currency. Ignored if set.")
    ...
    is_parent: Optional[StrictBool] = Field(default=None, description="System defined boolean indicating if this transaction was split. To split or unsplit a transaction use the `/transactions/split` endpoint. Ignored if set.")
    children: Optional[List[ChildTransactionObject]] = Field(default=None, description="An array of child transactions that exists when a transaction has been split or if the transaction is a group. Split and Grouped transactions may not be modified using this API. Ignored if set.")
    parent_id: Optional[StrictInt] = Field(default=None, description="A transaction ID if this is a split transaction. Split transactions may not be modified this API. Use the `transactions/split` endpoint instead. Ignored if set.")
    is_group: Optional[StrictBool] = Field(default=None, description="System defined boolean indicating if this transaction represents a group of transactions. Grouped transactions may not be modified with this API. Use the `transactions/group` endpoint instead. Ignored if set.")
    group_id: Optional[StrictInt] = Field(default=None, description="A transaction group ID if this transaction is part of a group. Grouped transactions may not be modified with this API. Use the `transactions/group` endpoint instead. Ignored if set.")
    ...
    __properties: ClassVar[List[str]] = ["id", "date", "amount", "currency", "recurring_id", "payee", "category_id", "notes", "manual_account_id", "plaid_account_id", "tag_ids", "additional_tag_ids", "external_id", "custom_metadata", "status", "to_base", "is_pending", "plaid_metadata", "created_at", "updated_at", "is_parent", "children", "parent_id", "is_group", "group_id", "source"]
