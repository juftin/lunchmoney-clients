...
class CryptoManualListResponseObject(BaseModel):
    """
    CryptoManualListResponseObject
    """ # noqa: E501
    crypto_manual: List[CryptoManualObject]
    __properties: ClassVar[List[str]] = ["crypto_manual"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in crypto_manual (list)
        _items = []
        if self.crypto_manual:
            for _item_crypto_manual in self.crypto_manual:
                if _item_crypto_manual:
                    _items.append(_item_crypto_manual.to_dict())
            _dict['crypto_manual'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "crypto_manual": [CryptoManualObject.from_dict(_item) for _item in obj["crypto_manual"]] if obj.get("crypto_manual") is not None else None
        })
        return _obj
