...
class UserObject(BaseModel):
    ...
    debits_as_negative: StrictBool = Field(description="Describes how negative amounts in transactions should be interpreted.")
    ...
    __properties: ClassVar[List[str]] = ["name", "email", "id", "account_id", "budget_name", "primary_currency", "debits_as_negative", "api_key_label"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "debits_as_negative": obj.get("debits_as_negative"),
