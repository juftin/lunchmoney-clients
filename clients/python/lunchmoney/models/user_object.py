...
class UserObject(BaseModel):
    ...
    account_id: StrictInt = Field(description="Unique ID for the linked budgeting account")
    budget_name: StrictStr = Field(description="Name of the linked budgeting account")
    primary_currency: CurrencyEnum = Field(description="Primary currency set in the user's settings")
