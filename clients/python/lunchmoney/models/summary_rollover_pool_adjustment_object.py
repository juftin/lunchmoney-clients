...
class SummaryRolloverPoolAdjustmentObject(BaseModel):
    ...
    """ # noqa: E501
    current: StrictBool = Field(description="true if this is the current rollover pool balance.")
    ...
    __properties: ClassVar[List[str]] = ["current", "date", "amount", "currency", "to_base"]
