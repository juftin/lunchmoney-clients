...
with lunchmoney.ApiClient(configuration) as api_client:
    ...
    is_group = True # bool | Filter by group (returns only transaction groups if `true`) (optional)
 ...
 **is_group** | **bool**| Filter by group (returns only transaction groups if &#x60;true&#x60;) | [optional] 
