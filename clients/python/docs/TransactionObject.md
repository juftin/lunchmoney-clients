...
**files** | [**List[TransactionAttachmentObject]**](TransactionAttachmentObject.md) | A list of objects that describe any attachments to the transaction. This is only present when the &#x60;include_files&#x60; query parameter is set to true. | [optional] 
