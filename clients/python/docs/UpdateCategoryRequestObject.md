...
**collapsed** | **bool** | If &#x60;true&#x60;, the category group is collapsed in the Lunch Money GUI. This property can only be set to &#x60;true&#x60; for category groups (&#x60;is_group: true&#x60;). While this property can be set via the API, it is generally set by the user in the Lunch Money GUI. | [optional] 
