...
// APIClient manages communication with the Lunch Money API - v2 API v2.11.0
...
type APIClient struct {
	...
	BalanceHistoryAPI *BalanceHistoryAPIService

	BudgetsAPI *BudgetsAPIService

	CategoriesAPI *CategoriesAPIService

	CryptoManualAPI *CryptoManualAPIService

	CryptoSyncedAPI *CryptoSyncedAPIService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	// API Services
	c.BalanceHistoryAPI = (*BalanceHistoryAPIService)(&c.common)
	c.BudgetsAPI = (*BudgetsAPIService)(&c.common)
	c.CategoriesAPI = (*CategoriesAPIService)(&c.common)
	c.CryptoManualAPI = (*CryptoManualAPIService)(&c.common)
	c.CryptoSyncedAPI = (*CryptoSyncedAPIService)(&c.common)
