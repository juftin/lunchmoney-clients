...
// Sets the maximum number of transactions to return. If more match the filter criteria, the response will include a &#x60;has_more&#x60; attribute set to &#x60;true&#x60;. See [pagination](foo)
func (r ApiGetAllTransactionsRequest) Limit(limit int32) ApiGetAllTransactionsRequest {
	r.limit = &limit
	return r
}

// Sets the offset for the records returned. This is typically set automatically in the header. See [Pagination](/foo)
