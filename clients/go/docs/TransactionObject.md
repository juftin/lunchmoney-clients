...
**ToBase** | **float64** | The amount converted to the user&#39;s primary currency. If the multi-currency feature is not being used, to_base and amount will be the same. By default a negative value indicates a debit transaction, however if the user&#39;s &#x60;debits_as_negative&#x60; property is set to false the opposite is true. | 
