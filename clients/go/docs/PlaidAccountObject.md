...
**AllowTransactionModifications** | **bool** | If &#x60;false&#x60;, transactions imported for this synced account can have their properties (such as amount and account) be modified by the user. This option is managed in the Lunch Money app. | 
