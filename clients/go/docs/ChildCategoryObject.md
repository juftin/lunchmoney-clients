...
**IsIncome** | **bool** | If true, transactions in this category are treated as income. (Inherited from the Category Group). | 
**ExcludeFromBudget** | **bool** | If true, transactions in this category are excluded from the budget. (Inherited from Category Group). | 
**ExcludeFromTotals** | **bool** | If true, transactions in this category are excluded from totals. (Inherited from Category Group). | 
**UpdatedAt** | **time.Time** | Date and time the category was last updated (ISO 8601 extended format). | 
**CreatedAt** | **time.Time** | Date and time the category was created (ISO 8601 extended format). | 
...
**IsGroup** | **bool** | Always false for categories that belong to a category group | 
...
**Order** | **NullableInt32** | Position of the category on the categories page in the Lunch Money app. For grouped categories, the order is relative to the others in the same group. | 
